...
class Inpainter():
    def __init__(self, image, mask, patch_size=9, plot_progress=False,
        ...
        # increasing this value penalizes more the distant patches
        # ------------------------------------------------------------------
        # ==================================================================
    ...
    def inpaint(self):
        ...
        while keep_going:
            ...
            source_data = self._find_source_patch(target_pixel)
            print('Time to find best: %f seconds'
                  % (time.time()-find_start_time))

            self._update_image(target_pixel, source_data)
    ...
    # New Implementation [_find_source_patch()]
    # =======================================================================
    # -----------------------------------------------------------------------
    ...
    def _find_source_patch(self, target_pixel):
        ...
        # weighted sum of `top_k_match` patch data
    ...
    # ==================================================================
    # This method now gets `source_data` arg instead of `source_patch`
    def _update_image(self, target_pixel, source_data):
        target_patch = self._get_patch(target_pixel)
    ...
    # ==================================================================
    # This method now returns `squared_distance` and `euclidean_distance`
    # separately.
